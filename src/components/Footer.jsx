...
import { Sofa1 ,EmailBoxicon} from '../assets'
  ...
  return (
    ...
    <div className="container relative">
        ...
        <div className="sofa-img">
            <img src={Sofa1} alt="Image" className="img-fluid"/>
        </div>

        <div className="row">
            <div className="col-lg-8">
                <div className="subscription-form">
                    <h3 className="d-flex align-items-center"><span className="me-1"><img src={EmailBoxicon} alt="Image" className="img-fluid"/></span><span>Subscribe to Newsletter</span></h3>
